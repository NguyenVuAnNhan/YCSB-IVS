...
# Define input and output filenames
INPUT_FILE="../analysis/postgresql_array_output.csv"
OUTPUT_FILE="../analysis/Data/postgresql_array_run1_spreadrun_heavy.csv"
...
for epoch in $(seq 1 10); do
    for run in $(seq 1 10); do
        ...
        $YCSB run jdbc-array -s -P $WORKLOAD_FILE -P $JDBC_PROPERTIES -p db.url="$DB_URL" -p db.user="$DB_USERNAME" -p db.passwd="$DB_PWD" > $OUTPUT_CSV
